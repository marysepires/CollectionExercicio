...
public class Main {
	...
	public static void main(String[] args) {
		...
		li.insereLis("Paula");
		li.insereLis("Karla");
		li.listaVazia(); // Verificação de a Lista ainda está vazia
		...
		pi.pilhaVazia(); // Verificação de a Pilha está vazia
		...
		pi.pilhaVazia(); //// Verificação de a Pilha ainda está vazia
